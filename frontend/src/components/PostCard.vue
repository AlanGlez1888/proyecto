<template>
  <article class="post" :style="{ '--accent': accentColor }">
    ...
    <div class="post-body">
      ...
      <div class="post-footer">
        ...
        <button class="like" type="button" @click="post.likes++">
...
<style scoped>
.post { display: flex; gap: 1rem; padding: 1.1rem 0; border-bottom: 1px solid var(--line); }
